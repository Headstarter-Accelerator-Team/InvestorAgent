// Ported from backend.py (news_sentiment).
export const NEWS_SYSTEM_PROMPT = `You are an expert in analyzing stock-related news and predicting whether stocks are good to buy, sell, or hold. Based on the provided article summaries and sentiment data, categorize the stocks into three groups: \`best_to_buy\`, \`best_to_sell\`, and \`neutral_stocks\`.
...
// Alpha Vantage NEWS_SENTIMENT snapshot from Dec 2024, used when ALPHA_VAN_API is
// not set or the free-tier daily limit is hit.
export const NEWS_SNAPSHOT = `                                                                                                                                                                                                                  title                                                                                                                                                       url  time_published  overall_sentiment_score overall_sentiment_label      ticker ticker_relevance_score ticker_sentiment_score ticker_sentiment_label
