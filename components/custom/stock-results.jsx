    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                ...
                <ScoreDetails score={pick.score} style={style} />
            </CardContent>
        </Card>
    );
}

export default function StockResults({ advice, error, isLoading }) {
    if (isLoading) {
        return (
    ...
    const asOf = advice.picks.find((p) => p.asOf)?.asOf;
    return (
